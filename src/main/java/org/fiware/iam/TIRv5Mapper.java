 ...
 *
 * <p>Handles Base64 encoding of credential bodies, SHA-256 hex-encoded hashing
 * for attribute IDs, and mapping of v5-specific fields ({@code issuerType},
 * {@code tao}, {@code rootTao}).</p>
 */
...
public interface TIRv5Mapper {
	 ...
	 *
	 * <p>This is auto-generated by MapStruct and used internally to produce the JSON
	 * payload that is then Base64-encoded for the v5 attribute body.</p>
	 *
	 ...
	 *
	 * <p>Handles the deserialization of stored claim values back to their original
	 * object representations. Reuses {@link TILMapper#readToObject} for value parsing.</p>
	 *
	 ...
	 *
	 * <p>Serializes the credential to JSON, Base64-encodes the body, computes
	 * a SHA-256 hex-encoded hash, and maps the v5-specific fields
	 * ({@code issuerType}, {@code tao}, {@code rootTao}).</p>
	 *
	 * @param credential the credential entity
	...
	default AttributeVO credentialToAttributeVO(Credential credential) {
		...
		try {
			...
			LOGGER.warn("Was not able to process credential {}. Will not include full data.",
					credential.getId(), e);
		}
	...
	/**
	 * Computes the v5 attribute ID for a credential as a SHA-256 hex-encoded hash
	 * of the Base64-encoded credential body.
	 *
	 * @param credential the credential entity
	...
	default String computeAttributeId(Credential credential) {
		...
		try {
			...
			LOGGER.warn("Was not able to compute attribute ID for credential {}.",
					credential.getId(), e);
			return "";
		}
	}
	...
	/**
	 * Maps a {@link Credential} entity to a v5 {@link AttributeDetailsVO},
	 * wrapping the attribute with the issuer's DID.
	 *
	 ...
	 *
	 * <p>Returns {@link AttributeVO.IssuerType#UNDEFINED} for null or unrecognized values.</p>
	 *
	...
	default AttributeVO.IssuerType mapIssuerType(String issuerType) {
		...
		return AttributeVO.IssuerType.toOptional(issuerType)
				.orElse(AttributeVO.IssuerType.UNDEFINED);
	}
